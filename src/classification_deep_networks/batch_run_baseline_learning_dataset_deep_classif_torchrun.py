...
model_name_list = ['ResNet50']                      # ['ResNet18', 'ResNet34', 'ResNet50', 'ResNet101', 'ResNet152']
...
for dataset_name, \
    ...
    dir_log = os.path.join(
        ...
        dataset_name,
        'baseline',
        model_name + str_pretrained + str_no_pooling_or_stride_conv1 + str_no_change_deep_layers,
    ...
    p = subprocess.Popen(
        ...
        f' torchrun'
        f' --standalone --nproc_per_node=gpu baseline_learning_dataset_deep_classif_torchrun.py'
