...
for dataset_name, \
    ...
    dir_log = os.path.join(
        ...
        'classification',
        dataset_name,
        'deform_conv2d_ker_fixed' if ker_fixed == 'True' else 'deform_conv2d',
    ...
    # print(
    #     f' torchrun --standalone --nproc_per_node=gpu deform_conv2d_learning_dataset_deep_classif_torchrun_lastReplacement.py'
    ...
    p = subprocess.Popen(
        ...
        f'srun -c 32 --gres=gpu:1'  # --gres=gpu:8
        f' -v'  # verbose
